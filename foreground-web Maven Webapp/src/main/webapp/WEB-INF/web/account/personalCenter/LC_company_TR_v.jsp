   				...
   				<!-- 在此处写入代码 -->
   					...
   					<div class="authenContent">
	   					<div class="authen">
			   				<ul class="inputArea">
			   					<li class="inputList">
			   						<div class="mustLabel"><span>证件编号：</span></div>
			   						<div class="introduceContent">111000111214214114</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>颁发机关：</span></div>
			   						<div class="introduceContent">工商行政管理局</div>
			   					</li>
			   					<li class="inputList">
