                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                            	<li><a href="web/frontconfig/frontconfig.jsp"><i class="fa fa-edit"></i>PC首页宣传图片管理	</a></li>
								<li><a href="web/frontconfig/frontconfig.jsp"><i class="fa fa-edit"></i>PC积分商城轮播图管理</a></li>
								<li><a href="web/frontconfig/cf-notice.jsp"><i class="fa fa-edit"></i>网站公告管理        </a></li>
								<li><a href="front/toTeamList.do"><i class="fa fa-edit"></i>管理团队管理        </a></li>
								<li><a href="web/frontconfig/cf-experts.jsp"><i class="fa fa-edit"></i>专家顾问管理        </a></li>
								...
								<li><a href="web/frontconfig/frontconfig.jsp"><i class="fa fa-edit"></i>合作伙伴管理        </a></li>
