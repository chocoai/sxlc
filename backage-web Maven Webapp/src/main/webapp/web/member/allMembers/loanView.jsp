					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<form id="" class="alignment" action="">
								...
								<div>
									<span class="con-item textRight2"><span>提交借款时间</span><input type="text" id="startDate2" class="dateInput Wdate" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate2\')||\'2020-10-01\'}' })" ><span class="line"></span><input type="text" id="endDate2" class="dateInput Wdate"  onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate2\')}' ,maxDate:'2020-10-01' })" ></span>
									<span class="con-item textRight2"><span class="approval">审批通过时间</span><input type="text" id="startDate3" class="dateInput Wdate" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate3\')||\'2020-10-01\'}' })" ><span class="line"></span><input type="text" id="endDate3" class="dateInput Wdate"  onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate3\')}' ,maxDate:'2020-10-01' })" ></span>
								</div>
								<div>	
