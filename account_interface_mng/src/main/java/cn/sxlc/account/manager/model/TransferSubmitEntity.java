...
public class TransferSubmitEntity {
    ...
    public static final String TRANSFER_ACTION_TYPE_TENDER = "1";
    public static final String TRANSFER_ACTION_TYPE_PAYMENT = "2";
    public static final String TRANSFER_ACTION_TYPE_OTHER = "3";

    public static final String ACTION_TYPE_MANUAL = "1";
