		   					...
		   					<form id="ocBox">
				   				<ul class="inputArea">
				   					<li class="inputList">
				   						...
				   						<input class="inputText numberReg" type="text" datatype="orgcodefmt" lang="请输入组织机构代码" maxlength="9"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>颁发时间：</span></div>
				   						<input class="inputText dateSelect Wdate"  onfocus="WdatePicker()" type="text" lang="请选择颁发时间"/>
				   					</li>
				   					<li class="inputList">
