						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									...
									<span class="con-item"><span>实际借款金额</span><input type="text" class="notspecial Wdate" onFocus="WdatePicker()"/></span>
									<span class="con-item"><span>最近一期还款时间范围</span><input type="text" id="startDate1" class="notspecial Wdate" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate1\')||\'2020-10-01\'}' })" />-&nbsp;&nbsp;<input type="text" id="endDate1" class="notspecial Wdate" onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate1\')}' ,maxDate:'2020-10-01' })" /></span>
