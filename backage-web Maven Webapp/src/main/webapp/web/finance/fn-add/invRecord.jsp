		...
		<div class="panel-body">
			...
			<input id="stype" type="hidden" value="<%=pAuthCode %>" />
				<div>
					...
					<span class="con-item">
						<span>投资成功时间段</span><input type="text" id="startDate" class="dateInput Wdate notspecial" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate\')||\'2020-10-01\'}' })" ><span class="line"></span><input type="text" id="endDate" class="dateInput Wdate"  onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate\')}' ,maxDate:'2020-10-01' })" >
					</span>
...
<div class="data_display">
	<div class="panel panel-success">
		<div class="panel-body">
			<table id="table_invRecordId" class="display">
			</table>
		</div>
	</div>
</div>
...
<script type="text/javascript" src="js/finance/invRecord.js"></script>
<script type="text/javascript">
$(".breadcrumb li.active").remove();
$(".breadcrumb").append("<li><a href='web/finance/fn-cms-statistics.jsp'>佣金发放</a></li><li class='active'>推荐投资提奖明细</li>");
</script>
<script type="text/javascript">
