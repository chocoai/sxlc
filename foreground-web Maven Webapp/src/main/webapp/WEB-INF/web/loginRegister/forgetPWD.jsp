...
<body>
	...
	<div class="main">
			...
			<div class="forgetPWD-box clearfix">
				...
				<div class="input-info input-group1 on">
					<div class="inputUserName clearfix">
						...
						<input type="text" class="input-user-name" datatype="logname"
					...
					<div class="inputTelNum clearfix">
						...
						<input type="text" class="input-tel-num numberReg"
							datatype="zPhone" value="请输入手机号" maxlength="11"
							onFocus="if(value==defaultValue){value='';this.style.color='#000';}"
							onBlur="if(!value){value=defaultValue;this.style.color='#bfbfbf';}"
							style="color:#bfbfbf">
					</div>
					<div class="inputImgCheck clearfix">
						...
						<div class="forgetPWDCode">
							<input type="text" class="img-check" datatype="imgcode"
								value="请输入图形验证码" maxlength="6"
								onFocus="if(value==defaultValue){value='';this.style.color='#000';}"
								onBlur="if(!value){value=defaultValue;this.style.color='#bfbfbf';}"
								style="color:#bfbfbf">
								<img src="authImage.html?type=1">
						</div>
					</div>
					<div class="inputTelCheck clearfix">
						...
						<div class="telCode">
							...
							<input type="button" class="get-tel-check"
								id="sendForgetPWDPhoneVarCode" value="获取验证码">
						</div>
					</div>
					<div class="nextBtn">
			...
			<div class="input-info input-group2">
				<div class="inputPWDNew clearfix">
					...
					<input type="password" name="password" class="password-new"
						datatype="regpass" maxlength="16">
				</div>
				<div class="inputPWDNew2 clearfix">
					<div class="left-title">请确认新密码:</div>
					<input type="password" class="password-new2" recheck="password"
						datatype="regpass" maxlength="16">
				</div>
				<div class="inputImgCheck clearfix">
					<div class="left-title">图形验证码:</div>
		...
		<div class="input-info info">
			<h2>恭喜，您的密码已修改成功</h2>
			<p>
				祝您在四象金融愉快!请<a href="login.html">重新登录</a>您的账户
			</p>
		</div>
	</div>
