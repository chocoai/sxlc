 ...
 * 显示所有已分配理财顾问会员
 */
function showMemberHaveAdviserList(){
...
//					aaSorting : [ [ 16, "desc" ] ],// 默认第几个排序
		        ...
		        ajax: {  
		            "url": appPath+"/adviserPlaner/memberAlreadyPlaner.do",   
		            "dataSrc": "results",   
		            "data": function ( d ) {
		            	var memberType = $("#memberType").val();
		            	...
		            	planner = encrypt.encrypt(planner);
