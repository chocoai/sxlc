...
/** 
* @Title: MyAccountHomeListDao.java 
* @Package cn.springmvc.dao 
* @Description: TODO 
* Copyright: Copyright (c) 2016 
* Company:成都四象联创科技有限公司 
* @author 刘利 
* @date 2016-4-7 上午10:08:03 
* @version V5.0 */
...
public interface MyAccountHomeListDao {
	/**
	 * 我的账户首页-账户信息查询 
	 * @author 刘利   
	 * @Description: TODO 
	 ...
	 * @author 刘利   
	 * @Description: TODO 
	 * @param  map #{skey}#{Member_ID}#{Month_Min}#{Month_Max}
	 * @param @return 设定文件 
	 ...
	 * @author 刘利   
	 * @Description: TODO 
	 * @param  map #{skey}#{Member_ID}#{Month}
	 * @param @return 设定文件 
	 * @return List<IncomeReplayPlanEntity> 返回类型 
