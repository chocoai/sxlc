   				...
   				<!-- 在此处写入代码 -->
   					...
   					<div class="authenContent">
	   					<div class="authen">
			   				<ul class="inputArea">
			   					<li class="inputList">
			   						<div class="mustLabel"><span>文件概要：</span></div>
			   						<div class="introduceContent">记录了什么什么</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>颁发机构：</span></div>
			   						<div class="introduceContent">国务院</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>颁发时间：</span></div>
			   						<div class="introduceContent">2014-01-01</div>
			   					</li>
			   					<li class="inputList">
