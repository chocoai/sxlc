...
<body class="nav-md">
				...
				<div class="nav-tabs-con active">
					<div class="data_display">
						...
						<div class="w-content ishow detailAuthen realnameAuthen">
							<fieldset>
								<legend class="titleLen">开户许可认证认证</legend>
								<div class="introduce">
								<input type="hidden" id="hostPath" value="${ImgProfix}"/>
									...
									<span><samp>开户许可证编号：</samp><label id="permitsCode"></label></span>
								</div>
								<div class="introduce">
									<span><samp>开户银行：</samp><label id="permitsBank"></label></span>
									<span><samp>银行账号：</samp><label id="bankNo"></label></span>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/accounOpeningLicense.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/companyIdentySorts/accountOpenIdenty.js"></script>
