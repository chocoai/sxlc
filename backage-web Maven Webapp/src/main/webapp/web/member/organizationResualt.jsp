...
<body class="nav-md">
				...
				<div class="nav-tabs-con active">
					<div class="data_display">
						...
						<div class="w-content ishow detailAuthen realnameAuthen">
							<fieldset>
								<legend class="titleLen">组织机构代码认证</legend>
								<div class="introduce">
								<input type="hidden" id="hostPath" value="${ImgProfix}"/>
									...
									<span><samp>组织机构代码：</samp><label id="firmOC"></label></span>
								</div>
								<div class="introduce">
									<span><samp>颁发时间：</samp><label id="sRegDate"></label></span>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/organizationValidation.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/companyIdentySorts/organizationIdenty.js"></script>
