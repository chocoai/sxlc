...
<body class="nav-md">
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									...
									<span class="con-item"><span>逾期天数范围</span><input type="text" id="startDate" class="notspecial Wdate Overdue_Day_Min" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate\')||\'2020-10-01\'}' })"/>-&nbsp;&nbsp;<input type="text" id="endDate" class="notspecial Wdate Overdue_Day_Max" onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate\')}' ,maxDate:'2020-10-01' })"/></span>
									<span class="con-item"><span>应还日期范围</span><input type="text" id="startDate1" class="notspecial Wdate Repay_MaxTime_Min" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate1\')||\'2020-10-01\'}' })"/>-&nbsp;&nbsp;<input type="text" id="endDate1" class="notspecial Wdate Repay_MaxTime_Max" onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate1\')}' ,maxDate:'2020-10-01' })"/></span>
	...
	$(function() {	
		...
		$('#table_id').DataTable(
				{	
					ajax: {  
						"url": appPath+"/project/getLatePayments",   
						"dataSrc": "results", 
						"type": "POST",
						"data": function ( d ) {
							//加密
							...
							var Overdue_Day_Min = $(".Overdue_Day_Min").val();
							var Overdue_Day_Max = $(".Overdue_Day_Max").val();
							...
							d.Overdue_Day_Min = encrypt.encrypt(Overdue_Day_Min);
							d.Overdue_Day_Max = encrypt.encrypt(Overdue_Day_Max);
							d.Repay_MaxTime_Min = encrypt.encrypt(Repay_MaxTime_Min);
							d.Repay_MaxTime_Max = encrypt.encrypt(Repay_MaxTime_Max);
							
							//设置后台排序参数
							d.ordercolumn = encrypt.encrypt("REPAY_MAXTIME");//排序字段 OVERDUE_DAYS OVERDUE_AMOUNT REPAY_MAXTIME 
