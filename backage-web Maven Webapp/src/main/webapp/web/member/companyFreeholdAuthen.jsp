...
<body class="nav-md">
				...
				<div class="nav-tabs-con active">
					<div class="data_display">
						...
						<div class="buttonCombination" style="display:inline-block">
							<button class="cerfiedBtn" onclick="jump(<%=content %>,1,'web/member/companyFreeholdResualt.jsp')">认证</button>
							<button class="checkBtn" onclick="jump(<%=content %>,2,'web/member/companyFreeholdResualt.jsp')">查看</button>
						</div>
	...
	<script type="text/javascript" src="js/member/companyIdentyList/houseHolderList.js"></script>
