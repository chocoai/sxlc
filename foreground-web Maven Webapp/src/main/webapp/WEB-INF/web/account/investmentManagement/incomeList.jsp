...
<body> 
	   						...
	   						<ul class="revenueRecordUl">
	   							...
	   							<c:forEach items="${list }" var="ii">
									<li>
				   						...
				   						<div class="overdueIncome divOutside"><div class="divIntside"><div class="moneyFormat"></div></div></div>
				   						<div class="actualPaymentDate divOutside"><div class="divIntside"><div></div></div></div>
		   							</li>	   								
	   							</c:forEach>
	   						</ul>
	   						<div id="pager"></div>
	...
	<script type="text/javascript" src="js/account/investmentManagement/incomeList.js"></script>
</body>
</html>