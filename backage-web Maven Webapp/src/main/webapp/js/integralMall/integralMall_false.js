...
$("#false_search").on("click",function(){
	$('#applicationAudit2').DataTable().ajax.reload();
});
//表格初始化
$(function() {
	var appPath = getRootPath();//项目根路径
	$('#applicationAudit2').DataTable(
	{
		autoWidth : false,
		scrollY : 500,
        ...
        columns: [  
                  ...
                  { title:"撤销操作员","data": "adminName" },
                  { title:"订单撤销时间","data": "revocationTime" },
                  { title:"订单撤销原因","data": "revocationReason" }
                  ],
        "aaSorting" : [[0,1,7,8,9,11,"desc"]],//默认第几个排序
		"aoColumnDefs" : [
 ...
 var table = $('#applicationAudit2').DataTable();
//设置选中change颜色
 $('#applicationAudit2 tbody').on( 'click', 'tr', function () {
