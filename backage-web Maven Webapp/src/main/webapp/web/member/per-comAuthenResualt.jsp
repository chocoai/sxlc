...
<body class="nav-md">
							...
							<fieldset>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/per-senceAuthen.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/personalIdentySorts/identyDetail.js"></script>
