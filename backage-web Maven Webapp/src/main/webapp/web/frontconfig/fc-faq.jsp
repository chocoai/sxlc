...
<head>
	...
	<!-- 私用css -->
	<link rel="stylesheet" href="css/frontconfig/fc-faq.css" type="text/css"/>
</head>
<body class="nav-md">
	<div class="container body">
		<!-- 头部 -->
			...
			<jsp:include page="../common/cm-frontconfig.jsp">
				<jsp:param value="511" name="_index_m2"/>
	...
	<script type="text/javascript" src="js/frontconfig/fc-faq.js"></script>		
	<!-- 私用js -->
