   			...
   			<div class="accountRight">
   				...
   				<!-- 在此处写入代码 -->
   					...
   					<div class="authenContent">
	   					<div class="authen">
	   						<form id="apBox" class="person_Renzheng" >
				   				<ul class="inputArea">
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>文件概要：</span></div>
				   						<input class="inputText fileSummary " type="text" datatype="reMarks" lang="请输入文件概要" maxlength="25"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>颁发机构：</span></div>
				   						<input class="inputText issueOrgan " type="text" datatype="reMarks" lang="请输入颁发机构" maxlength="25"/>
				   					</li>
				   					<li class="inputList">
