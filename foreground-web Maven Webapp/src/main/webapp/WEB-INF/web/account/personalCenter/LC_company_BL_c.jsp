		   					...
		   					<form id="blBox">		   						
				   				<ul class="inputArea">
				   					<li class="inputList">
				   						...
				   						<input class="inputText numberReg" type="text" datatype="businessNum" lang="请输入营业执照号码" maxlength="15"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>注册地址：</span></div>
				   						<input class="inputText" type="text" datatype="enteraddr" lang="请输入注册地址" maxlength="25"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>注册法人：</span></div>
				   						<input class="inputText" type="text" datatype="legal" lang="请输入注册法人" maxlength="25"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>注册资金：</span></div>
				   						<input class="inputText format" type="text" datatype="acountM" lang="请输入注册资金" maxlength="12"/>
				   						<span class="unitPrice">元</span>
				   					</li>			   					
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>经营范围：</span></div>
				   						<input class="inputText" type="text" datatype="enteraddr" lang="请选择经营范围" maxlength="25"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span>公司类型：</span></div>
				   						<input class="inputText" type="text" datatype="enteraddr" lang="请输入公司类型" maxlength="25"/>
				   					</li>
				   					<li class="inputList">
