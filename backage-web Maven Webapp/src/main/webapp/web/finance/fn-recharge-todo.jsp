	...
	<div class="container body">
		<div class="main_container">
			...
			<jsp:include page="../common/cm-finance.jsp">
				<jsp:param value="405" name="_index_m2"/>
					...
					<div class="recharge col-lg-12">
						<form id="rechargeform" class="accrechargeform" action="account/recharge.do">
							...
							<span class="rechargecost">
										<span>支付充值费用：</span><label id="rechargeC" class="cost moneyFormat">0.00</label>元
							</span>
							<span class="acturallymoney">
										<span>实际到账金额：</span><label id="realMoney" class="creditedactually moneyFormat">0.00</label>元
							</span>
						</form>
						<div class="cmbtncontainer accrechargecon">
							<a class="commonbtn0">充值</a>
