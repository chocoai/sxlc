...
<body class="nav-md">
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<form id="" class="" action="">
								<span class="con-item"><span>项目编号</span><input type="text" class="notspecial" id="p_no" ></span>
								<span class="con-item"><span>项目名称</span><input type="text" class="notspecial" id="p_name"></span>
	...
	<!-- 私用js -->
	<script type="text/javascript" src="js/member/memberInvest.js"></script>
