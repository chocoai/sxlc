...
<head>
	...
	<!-- 私用css -->
	<link rel="stylesheet" href="css/recommend/present-record.css"/>
</head>
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
			...
			<jsp:include page="../common/cm-recommend.jsp">
				<jsp:param value="909" name="_index_m2"/>
	...
	<script type="text/javascript" src="js/recommend/present-record.js"></script>
