		...
		<div class="main_container">
			...
			<div class="right_col role-content">
				...
				<ul class="nav nav-tabs">
					<li><a href="web/role/role-manage-in.jsp">内部管理员</a></li>
					<li class="active"><a href="web/role/role-manage-out.jsp">外部管理员</a></li>
				</ul>
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<form id="" class="" action="">
								...
								<!-- 外部管理员的查询条件 -->
								<span class="con-item"><span>性质</span><input type="text" class="" placeholder="" /></span>
					...
					<div class="panel panel-success">
						<div class="panel-heading">
							<div class="action_item">
								...
								<button class="obtn glyphicon glyphicon-plus obtn-manage-add" onclick="manageAdd('添加外部管理员','0')">添加</button>
								<button class="obtn glyphicon glyphicon-pencil obtn-manage-mod" onclick="manageMod('修改外部管理员','0')">修改</button>
								<button class="obtn glyphicon glyphicon-trash obtn-manage-del" onclick="manageDel()">删除</button>
							</div>
						</div>
						<div class="panel-body">
							<table id="tb-manage-out" class="display">
								<thead>
									<tr>
