...
<head>
	<base href="<%=basePath%>">
	<title>会员管理-企业会员-会员理财顾问变更</title>
	<!-- 公用meta -->
							...
							<div class="panel-body">
								<form id="" class="" action="">
									<div>
										...
										<span class="con-item textRight"><span>公司名称</span><input type="text" class="notspecial"  id="personalName"/></span>
									</div>
									<div>
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="action_item">
									...
									<button  type="button"  class="obtn glyphicon examine" onclick="inquiryFinancialAdvisor();">查询历史理财顾问</button>
								</div>
							</div>
