			   				...
			   				<form id="securityCheck">
		   						<ul class="inputArea">
				   					<li class="inputList">
				   						...
				   						<input class="inputText inputRealName" type="text" datatype="enterperson" lang="请输入姓名" maxlength="20"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>身份证号：</span></div>
				   						<input class="inputText personId" type="text" lang="请输入您的身份证号" datatype="IDCard" maxlength="18"/>
				   					</li>
				   					<!-- <li class="inputList">
		   					        ...
		   					        <li class="contetnList">
		   								<div class="btn emailBtn nameBtn phoneSubmit">确定</div>
		   							</li>
				   				</ul>
	   						</form>
	   					</div>
