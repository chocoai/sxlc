...
$(function() {
	...
	$('#table_vipRecordId').DataTable(
	{
        ...
        ajax: {  
            "url": appPath + "/commission/vipList.do",   
            "dataSrc": "results", 
            "data": function ( d ) {  
        ...
        columns: [  
                  ...
                  { title:"购买有效时间段","data": "", 
                	  "mRender": function (data, type, full) {
                			 return full.certifySDate + "~" + full.certifyEDate;
                	  } 
                  },
                  { title:"购买金额","data": "amounts" },
                  { title:"支付时间","data": "recordDate" }
 ...
 var table = $('#table_vipRecordId').DataTable();
//设置选中change颜色
 $('#table_vipRecordId tbody').on( 'click', 'tr', function () {
