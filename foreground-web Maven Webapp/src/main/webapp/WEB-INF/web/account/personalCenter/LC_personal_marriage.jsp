	   					...
	   					<div class="authen">
			   				<ul class="inputArea">
			   					<li class="inputList">
			   						...
			   						<div class="radio checked" onselectstart="return false">已婚</div>
			   						<div class="radio" onselectstart="return false">未婚</div>
			   					</li>
			   					<li class="inputList">
		   						...
		   						<div class="labelChange" style="display:inline-block;vertical-align:top;"><div class="mustLabel"><span><samp>*</samp>附件：</span></div></div>
