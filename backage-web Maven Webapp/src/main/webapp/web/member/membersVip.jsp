...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
			...
			<jsp:include page="../common/cm-member.jsp">
				...
				<jsp:param value="20102" name="_index_m3"/>
			</jsp:include>
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="action_item">
									<button class="obtn glyphicon examineVip" onclick="detailView();">查看会员详情</button>
	...
	$('#table_id').DataTable({
		"scrollX":true,
		//"scrollY":true,
		"aaSorting" : [ [ 7,9,10,11,12, "desc" ] ],//默认第几个排序
		"aoColumnDefs" : [
