	   	...
	   	<div class="auto-top">
	   		...
	   		<div class="info-input1 info">
	   			...
	   			<div class="input-group-out">
					...
					<label><input type="radio" name="tag" value="到期">到期还本息</label>
	   			</div>			
	   		</div>
	   		<div class="info-input2">
	   			...
	   			<div class="input-group-out">
		   			<div class="input-group">
		   				<input class="numberReg" type="text" maxlength="4">
		   				<span>-</span>
		   				<input class="numberReg" type="text" maxlength="4">
		   				<span>年</span>
		   			</div>
		   			<div class="input-group">
		   				<input class="numberReg" type="text" maxlength="2">
		   				<span>-</span>
		   				<input class="numberReg" type="text" maxlength="2">
		   				<span>月</span>
		   			</div>
	   		...
	   		<div class="info-input3">
	   			<div class="left-title">每次投标金额:</div>
	   			<input class="format" type="text" lang="请输入每次投标金额" maxlength="10">
	   			<span>元</span>
	   		</div>
	   		<div class="remind">
	   		...
	   		<div class="info-input3">
	   			...
	   			<input class="format" type="text" lang="请输入最低预留金额" maxlength="10">
	   			<span>元</span>
	   		</div>
   		</div>
   		<div class="auto-bottom">
   			<input type="button" class="autoBtn" value="确定" onclick="layer.closeAll()">
   		</div>
   	</div>
