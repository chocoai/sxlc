	...
	<div class="container body">
		<div class="main_container">
			...
			<jsp:include page="../common/cm-project.jsp">
				...
				<jsp:param value="30507" name="_index_m3"/>
			</jsp:include>
			<!-- 主要内容 -->
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									...
									<span class="con-item"><span>实际借款金额</span><input type="text" class="notspecial dateInput Invest_Amount_Valid_Min" />-&nbsp;&nbsp;<input type="text" class="notspecial dateInput Invest_Amount_Valid_MAX"  /></span>
									<span class="con-item"><span>最近一期还款时间</span><input type="text" id="startDate1" class="notspecial Wdate dateInput Repay_Time_Min" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate1\')||\'2020-10-01\'}' })" />-&nbsp;&nbsp;<input type="text" id="endDate1" class="notspecial Wdate dateInput Repay_Time_Max" onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate1\')}' ,maxDate:'2020-10-01' })" /></span>
