						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									<span class="con-item"><span>活动点名称</span><input type="text" class="" value="活动点名称" /></span>
									<span class="con-item"><span>关联操作权限名称</span><input type="text" class="" value="关联操作权限名称" /></span>
									<span class="con-item"><span>活动点状态</span><input type="text" class="" value="活动点状态" /></span>
					...
					<div class="w-content proexam-point-add">
						<table>
							<tr>
								...
								<td class="con">
									<input type="text" class="" placeholder="活动点名称" value="" />
								</td>
							</tr>
							<tr>
								<td class="tt"><label class="ineed">关联操作权限名称：</label></td>
								<td class="con">
									<input type="text" class="" placeholder="关联操作权限名称" value="" />
								</td>
							</tr>
							<tr>
								<td class="tt"><label>状态：</label></td>
								<td class="con">
									<input type="radio" name="state" class="" value="1" /> 有效
									<input type="radio" name="state" class="" value="2" /> 无效
								</td>
							</tr>
							<tr>
