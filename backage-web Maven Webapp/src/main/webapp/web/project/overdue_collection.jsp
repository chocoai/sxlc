		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="active"><a href="web/project/overdue_collection.jsp">逾期催收</a>
					</li>
					<li role="presentation" class=""><a href="web/project/collection_has_bill.jsp">催收已还账单</a>
					</li>
				</ul>
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									...
									<span class="con-item"><span>还款时间</span><input type="text" class="" value="还款时间" /></span>
						...
						<div class="panel panel-success">
							<div class="panel-heading">
							  	<div class="action_item">
						  			<button id="overdue_collection_callback" class="obtn glyphicon glyphicon-plus">电话回访</button>
						  			<button id="overdue_collection_generate_bill" class="obtn glyphicon glyphicon-plus">生成账单</button>
								</div>
							</div>
						<div class="panel-body">
