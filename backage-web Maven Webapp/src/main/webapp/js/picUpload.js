 ...
 * 
 */
function picUpload(pickBtn,fileList,index,urlBtn,width,height) {
			//上传初始化
			var uploader = WebUploader.create({
			    ...
			    // 选择文件的按钮。可选。
			    pick: pickBtn,											//内部根据当前运行是创建，可能是input元素，也可能是flash.
			    fileNumLimit: 1,												//个数限制
...
//			                '<div class="info">' + file.name + '</div>' +
			    	...
			    	$del = $('<div class="file-panel"><span class="cancel"></span></div>'),
			        $img = $li.find('img');
