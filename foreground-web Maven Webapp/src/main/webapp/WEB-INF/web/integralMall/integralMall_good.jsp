						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="action_item">
									...
									<button class="obtn glyphicon glyphicon-plus obtn-export" onclick="window.location='web/integralMall/good_rdd.jsp'">查看入库记录</button>
									<button class="obtn glyphicon glyphicon-plus obtn-export" onclick="bankManagementKdd('入库','web/integralMall/good_kdd.jsp','1')">入库</button>
									<button class="obtn glyphicon glyphicon-plus obtn-export" onclick="bankManagementVdd('设置VIP折扣','web/integralMall/good_vdd.jsp','1')">设置VIP折扣</button>
								</div>
							</div>
