...
/** 
* @Title: BackgroundDataStatisticsService.java 
* @Package cn.springmvc.service 
* @Description: TODO 
* Copyright: Copyright (c) 2016 
* Company:成都四象联创科技有限公司 
* @author 刘利 
* @date 2016-4-27 上午11:56:24 
* @version V5.0 */
...
public interface BackgroundDataStatisticsService {
	/** 
	 * @author 刘利   
	 * @Description: 运营项目统计 
	 * @param @return 设定文件 
     ...
     * @author 刘利   
     * @Description: TODO 
     * @param map {DateStr：'20150401'即是'%Y%m%d'}
     * @param @return 设定文件 
     ...
     * @author 刘利   
     * @Description: TODO 
     * @param map {DateStr：'201504'即是'%Y%m'}
     * @param @return 设定文件 
     * @return CoutEntity 返回类型 
     * @date 2016-4-27 下午6:32:27
     */
     ...
     * @author 刘利   
     * @Description: TODO 
     * @param @param map{startTime,endTime}
     * @param @return 设定文件 
     * @return OperationItemStatisticsEntity 返回类型 
    ...
    * @author 刘利   
    * @Description: TODO 
    * @param @param map {DateStr：'20150401'即是'%Y%m%d'}
    * @param @return 设定文件 
    * @return List<CoutEntity> 返回类型 
    * @date 2016-4-28 上午11:17:13
    */
    ...
    * @author 刘利   
    * @Description: TODO 
    * @param @param map {DateStr：'201504'即是'%Y%m'}
    * @param @return 设定文件 
    * @return List<CoutEntity> 返回类型 
    * @date 2016-4-28 上午11:17:13
    */
