   				...
   				<!-- 在此处写入代码 -->
   					...
   					<div class="authenContent">
	   					<div class="authen">	   		
			   				<ul class="inputArea">
			   					<li class="inputList">
			   						<div class="mustLabel"><span>住所：</span></div>
			   						<div class="introduceContent">成都市郫县犀浦十四对西区大道14-1</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>法人代表姓名：</span></div>
			   						<div class="introduceContent">王五</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>注册资本：</span></div>
			   						<div class="introduceContent">200万</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>公司类型：</span></div>
			   						<div class="introduceContent">广告经销商</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>实收资本：</span></div>
			   						<div class="introduceContent">300万</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>经营范围：</span></div>
			   						<div class="introduceContent">设计、定做</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>成立日期：</span></div>
			   						<div class="introduceContent">2015-04-01</div>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span>有效期：</span></div>
			   						<div class="introduceContent">2018-01-01</div>
			   					</li>
			   					<li class="inputList">
