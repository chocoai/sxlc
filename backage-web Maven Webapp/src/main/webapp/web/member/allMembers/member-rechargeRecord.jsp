...
<body class="nav-md">
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									<span class="con-item"><span>充值状态</span><select id="statu"><option value="1">成功</option><option value="0">失败</option></select></span>
									<span class="con-item"><span>第三方交易流水号</span><input type="text" class="notspecial" id="threeNum" /></span>
									<span class="con-item"><span>到账时间范围</span><input type="text" id="startDate" class="dateInput Wdate" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate\')||\'2020-10-01\'}' })" ><span class="line"></span><input type="text" id="endDate" class="dateInput Wdate"  onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate\')}' ,maxDate:'2020-10-01' })" ></span>
	...
	<script type="text/javascript" src="js/member/memberRecharge.js"></script>
	<script type="text/javascript">
		...
		showMemberRechargeList(memberId,memberType);
	</script>
</div>