...
public class PromptClient {
	 ...
	 * 构造函数
	 */
	public PromptClient(String sn, String password)
	 ...
	 */
	public String mdsmssend(String mobile, String content, String ext, String stime,String rrid,String msgfmt,String smsInterface) {
