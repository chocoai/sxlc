	   						...
	   						<form id="alBox">
				   				<ul class="inputArea">
				   					<li class="inputList">
				   						...
				   						<input class="inputText numberReg" datatype="accountOpen" type="text" lang="请输入开户许可证编号" maxlength="12"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>开户银行：</span></div>
				   						<input class="inputText" type="text" datatype="zbank" lang="请输入开户银行" maxlength="25"/>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span><samp>*</samp>银行帐号：</span></div>
				   						<input class="inputText numberReg" type="text" datatype="zbankNum" lang="请输入银行帐号" maxlength="18"/>
				   					</li>
				   					<li class="inputList">
