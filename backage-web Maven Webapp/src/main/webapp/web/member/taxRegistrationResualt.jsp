...
<body class="nav-md">
						...
						<div class="w-content ishow detailAuthen realnameAuthen">
							<fieldset>
								...
								<input type="hidden" id="hostPath" value="${ImgProfix}"/>
									...
									<span><samp>证件编号：</samp><label id="credentialsNO"></label></span>
								</div>
								<div class="introduce">
									<span><samp>颁发机关：</samp><label id="issueOrgan"></label></span>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/taxRegistrationAuthen.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/companyIdentySorts/taxRigisterIdenty.js"></script>
