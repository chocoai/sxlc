...
<body class="nav-md" style="min-width:350px;">
		...
		<div class="main_container">
			...
			<div class="w-content ishow">
					<table>
						<tr class="resetPwd">
							<td class="tt">新密码：</td> 
							<td class="con"><input name="password"  id="newpwd" type="password"  title="newpass" datatype="regpass" maxlength="16" ></td>
						</tr>
						<tr class="resetPwd">
							<td class="tt">确认密码：</td>
							<td class="con"><input type="password" id="snewpwd" datatype="repass" maxlength="16" ></td>
						</tr>
					</table>
			</div>
	...
	<script type="text/javascript">
		validform5(".layui-layer-btn0","resetpassword",false,"3");
