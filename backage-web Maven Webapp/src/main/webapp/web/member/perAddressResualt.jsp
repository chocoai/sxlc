...
<body class="nav-md">
				...
				<div class="nav-tabs-con active">
					<div class="data_display">
						...
						<div class="w-content ishow detailAuthen realnameAuthen">
							<fieldset>
								<legend class="titleLen">住址认证</legend>
								<div class="introduce">
								<input type="hidden" id="hostPath" value="${ImgProfix}"/>
									...
									<span><samp>地址：</samp><label id="houseAddress"></label></span>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/per-addressAuthen.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/personalIdentySorts/houseDetail.js"></script>
	<script type="text/javascript">
		var memberId = "<%=content%>";
		var typeId = <%=typeId %>;   /*  会员id  , 认证类型*///查看和认证判断
		var btn = "<%=btn%>"; 
