...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
			...
			<jsp:include page="../common/cm-frontconfig.jsp">
				<jsp:param value="515" name="_index_m2"/>
	...
	<script type="text/javascript">
		 $(function(){
			validform5("layui-layer-btn0","addnavtitle",false,"5");
		});
		$(function(){
			validform5("layui-layer-btn0","addnavlink",false,"5");
		});
		 $(function(){
			validform5("layui-layer-btn0","modnavtitle",false,"5");
		});
		$(function(){
			validform5("layui-layer-btn0","modnavlink",false,"5");
		});
