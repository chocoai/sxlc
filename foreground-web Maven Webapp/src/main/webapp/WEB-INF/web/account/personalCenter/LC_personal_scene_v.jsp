	   				...
	   				<div class="authenContent">
		   				<div class="authen clearfix">
		   				    ...
		   				    <div class="wdateSelect" <c:if test="${t==2||t==3 || t==4 || t==5 || t==6 || t==9||t==11 ||t==1136091|| t==16 || t==17 || t==20 || t==21 || t==24 }"> style="display:block" </c:if> >
	   							<span>有效期：</span>
	   							<input class="inputText dateSelect Wdate" type="text"  readonly="readonly"/>
		   					</div>
		   					<input type="hidden" value="2" class="editType" />
		   					<input type="hidden" value="${type}" class="authType" />
		   					</div>
		   					<div class="authPreviDiv_u" style="margin-left: 100px;"></div>		   							   			
		   				</div>
		   			</div>
	   			</div>
   			</div>
