...
public class FriendLinkController {
	...
	* @throws
	...
	public int save(HttpServletRequest request) {
		...
		if (url != null && url != "") {
			...
			int num = friendshipLinkService.insertFriendshipLink(friendEntity, entity, sIpInfo);
			return num;
	}
	...
	* @throws
	...
	public int update(HttpServletRequest request) {
		...
		int num = friendshipLinkService.updateFriendshipLinkByID(friendEntity, entity, sIpInfo);
		return num;
	...
	* @throws
	...
	public int delete (HttpServletRequest request) {
		...
		int num = friendshipLinkService.deleteFriendshipLinkByID(Integer.valueOf(friendLinkId), entity, sIpInfo);
