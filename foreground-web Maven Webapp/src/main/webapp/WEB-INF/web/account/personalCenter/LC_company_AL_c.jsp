	   						...
	   						<form id="alBox">	   						
				   				<ul class="inputArea">
				   					<li class="inputList">
				   						...
				   						<input class="inputText" datatype="accountOpen" type="text" lang="请输入开户许可证编号" maxlength="14"/>
				   					</li>
				   					<li class="inputList">
				   					...
				   					<li class="inputList">
				   						...
				   						<input class="inputText numberReg" datatype="zbankNum" type="text" lang="请输入银行帐号" maxlength="18"/>
				   					</li>
				   					<li class="inputList">
