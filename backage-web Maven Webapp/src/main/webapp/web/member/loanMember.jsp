...
<body class="nav-md">
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<jsp:include page="../common/cm-addr.jsp"></jsp:include>
					...
					<li role="presentation" class="active "><a href="javascript:;">借款会员</a></li>
					...
					<div class="panel panel-success boxRadius">
					  <div class="panel-heading">
						 <div class="action_item">
							...
							<button class="obtn glyphicon queryRecordQueryCunt">提现记录查询</button>
							<button class="obtn glyphicon rechargeRecordCunt">充值记录</button>
							<button class="obtn glyphicon transactionRecordCunt">交易详情</button>
						</div>
						</div>
	...
	<div class="transactionRecord">
		...
		<!-- 提现记录查询 -->
	<div class="queryRecordQuery">
		<div class="panel-body">
			<form class="" action="">
				<span class="con-item"><span>提现提交时间</span><input type="text" class="" placeholder="提现提交时间" /></span>
				<span class="con-item"><span>到账时间</span><input type="text" class="" placeholder="到账时间" /></span>
				<span class="con-item"><span>平台交易流水号</span><input type="text" class="" placeholder="平台交易流水号" /></span>
				<span class="con-item"><span>第三方交易流水号</span><input type="text" class="" placeholder="第三方交易流水号" /></span>
				<button class="obtn obtn-query glyphicon glyphicon-search">查询</button>
			</form>
		</div>
		<table id="queryRecordQueryTable" class="memberselect_b table table-hover ">
			<thead>
				<tr>
					<th rowspan="1" colspan="1">提现提交时间</th>
					<th>提现金额</th>
					<th>提现银行卡</th>
					<th>第三方手续费</th>
					<th>实际到账金额</th>
	...
	<div class="rechargeRecord">
		<div class="panel-body">
			<form class="" action="">
				<span class="con-item"><span>充值金额</span><input type="text" class="" placeholder="充值金额" /></span>
				<span class="con-item"><span>充值时间范围</span><input type="text" class="" placeholder="充值时间范围" /></span>
				<span class="con-item"><span>充值状态</span><input type="text" class="" placeholder="充值状态" /></span>
				<span class="con-item"><span>第三方交易流水号</span><input type="text" class="" placeholder="第三方交易流水号" /></span>
				<span class="con-item"><span>到账时间范围</span><input type="text" class="" placeholder="到账时间范围" /></span>
				<button class="obtn obtn-query glyphicon glyphicon-search">查询</button>
			</form>
		</div>
		<table id="rechargeRecordTable" class="memberselect_b table table-hover ">
			<thead>
				<tr>
					<th rowspan="1" colspan="1">充值金额</th>
					<th>充值时间</th>
					<th>第三方手续费</th>
					<th>实际到账金额</th>
					<th>到账时间</th>
