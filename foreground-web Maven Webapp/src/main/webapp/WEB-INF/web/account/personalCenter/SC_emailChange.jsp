   				...
   				<!-- 在此处写入代码 -->
	   				...
	   				<ul class="contentArea">
	   					<li class="contetnList" id="contetnList">
	   						<label>原邮箱号码：</label>
	   						<input class="email entryEmailChange" type="text" lang="请输入您的原邮箱号" maxlength="25" >
	   					</li>
	   					<li class="contetnList">
	   						<label>新邮箱号码：</label>
	   						<input class="email newEmail" type="text" lang="请输入您的新邮箱号" maxlength="25">
	   					</li>
	   					<li class="contetnList">
	   						<label>验证码：</label>
	   					...
	   					<li class="contetnList">
	   						<div class="btn emailBtn email-btn">确定</div>
	   					</li>
	   				</ul>
   				</div>
   			</div>
