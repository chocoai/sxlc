...
<body class="nav-md">
					...
					<div class="data_display">
						...
						<div class="w-content ishow detailAuthen realnameAuthen">
							<fieldset>
								...
								<div class="introduce">
									<span><samp>婚姻状况：</samp><label id="maritalName"></label></span>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/per-marrigeAuthen.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/personalIdentySorts/marryDetail.js"></script>
