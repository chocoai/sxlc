		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<ul class="nav nav-tabs">
					<li role="presentation" class="active"><a href="web/project/soon_due_bill.jsp">即将到期账单</a>
					</li>
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									...
									<span class="con-item"><span>还款时间范围</span><input type="text" class="" value="还款时间范围" /></span>
						...
						<div class="panel panel-success">
							<div class="panel-heading">
							  	<div class="action_item">
						  			<button id="soon_due_bill_alertmsg" class="obtn glyphicon glyphicon-plus">发送短信提醒</button>
								</div>
							</div>
						<div class="panel-body">
