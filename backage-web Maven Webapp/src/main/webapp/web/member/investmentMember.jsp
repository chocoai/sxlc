						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<form id="" class="" action="">
									...
									<span class="con-item"><span>第三方帐户</span><input type="text" class="notspecial" /></span>
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="action_item">
									...
									<button class="obtn glyphicon" onclick="bondTransforRecord()">债券转让记录</button>
	...
	<script type="text/javascript">
		$(function(){
			$('#table_id').DataTable({
				"scrollX":true,
				//"scrollY":true,
				"aaSorting" : [ [ 8,10,13,15, "desc" ] ],//默认第几个排序
				"aoColumnDefs" : [
				//{"bVisible": false, "aTargets": [ 3 ]}, //控制列的隐藏显示
				{
					"orderable" : false,
					"aTargets" : [0,1,2,3,4,5,6,7,9,11,12,14,16,17]
				} // 制定列不参与排序
				],
			});
		});
