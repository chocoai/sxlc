		...
		<div class="main_container">
			...
			<div class="right_col role-content">
				...
				<ul class="nav nav-tabs msgalerttab">
					<li role="presentation"   onclick="changePg(1)" class="changePg active"><a>手机短信</a>
					</li>
					<li role="presentation"   onclick="changePg(2)" class="changePg"><a>站内消息</a>
					</li>
					<li role="presentation"   onclick="changePg(3)" class="changePg"><a>邮件</a>
					</li>
				</ul>
				<!-- 数据显示 -->
				<div class="">
