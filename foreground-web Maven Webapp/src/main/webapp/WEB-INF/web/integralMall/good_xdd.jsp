				...
				<!-- 主体部分 -->
					...
					<table id="table_id">
						<tr>
							...
							<td class="con" id=""><select class="shi"><option value="">宠物粮食</option><option value="">萨摩耶食粮</option></select>
							</td>
						</tr>
						<tr>
							<td class="tt">商品名称</td>
							<td class="con" id=""><input type="text" id=""  datatype="enterAddress"/></td>
							<td class="tt ttt">所需积分</td>
							<td class="con" id=""><input type="text" id="" datatype="acountM" /></td>
						</tr>
						<tr>
							<td class="tt">结束日期</td>
							<td class="con" id=""><input class="Wdate" datatype="time" onFocus="WdatePicker()" /></td>
						...
						<tr>
							...
							<td class="con" id=""><input type="text"  datatype="acountM" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="con" colspan="3" id=""><input datatype="time" type="text" id="startDate" class="dateInput Wdate data1" onFocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate\')||\'2020-10-01\'}' })" ><span class="line"></span><input datatype="time" type="text" id="endDate" class="dateInput Wdate data1"  onFocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate\')}' ,maxDate:'2020-10-01' })" ></td>
						</tr>
						<tr>
