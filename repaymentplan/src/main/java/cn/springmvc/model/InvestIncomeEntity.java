...
public class InvestIncomeEntity {
	...
	public long       totalSDRecvPrincipal;// 	总的应收本金(单位：分)		
	public long       totalSDRecvInterest;// 总应收收益(单位：分)	
	public long getTotalSDRecvPrincipal() {
		return totalSDRecvPrincipal;
	}
	public void setTotalSDRecvPrincipal(long totalSDRecvPrincipal) {
		this.totalSDRecvPrincipal = totalSDRecvPrincipal;
	}
	public long getTotalSDRecvInterest() {
		return totalSDRecvInterest;
	}
	public void setTotalSDRecvInterest(long totalSDRecvInterest) {
		this.totalSDRecvInterest = totalSDRecvInterest;
	}
