...
<body class="nav-md">
				...
				<div class="nav-tabs-con active">
					<div class="data_display">
						...
						<div class="w-content ishow detailAuthen realnameAuthen">
							<fieldset>
								<legend class="titleLen">车产认证</legend>
								<div class="introduce">
								<input type="hidden" id="hostPath" value="${ImgProfix}"/>
									...
									<span><samp>车辆品牌：</samp><label id="brand"></label></span>
									<span><samp>车辆型号：</samp><label id="model"></label></span>
								</div>
								<div class="introduce">
									<span><samp>车牌号：</samp><label id="licensePlate"></label></span>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/companyVitureAuthen.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/companyIdentySorts/carHolderIdenty.js"></script>
