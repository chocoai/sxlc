	   					...
	   					<div class="cloneDiv">
		   					<div class="authen">
		   						<div class="authenScale">
		   							<p class="authenScaleBtn" onselectstart="return false" onclick="scale(this);">车产认证(川A111111)</p>
		   						</div>
				   				<ul class="inputArea">
				   					<li class="inputList">
				   					...
				   					<li class="inputList">
				   						...
				   						<div class="introduceContent">521214548652222</div>
				   					</li>
				   					<li class="inputList">
				   						<div class="mustLabel"><span>车牌号：</span></div>
				   						<div class="introduceContent">川A111111</div>
				   					</li>
				   					<li class="inputList">
