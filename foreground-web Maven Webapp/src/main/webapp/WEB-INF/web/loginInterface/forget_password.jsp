				...
				<div class="loginW">
					...
					<form action="" id="forget_pass">
						<div class="admUser">
							...
							<input type="text"  placeholder="手机号" name="adminName" id="adminName" maxlength="11" value="<%=svalue %>" onkeyup='this.value=this.value.replace(/\D/gi,"")'>
						</div>
						<div class="admPasword">
							...
							<img alt="获取验证码" id="yanzheng" style="width: 90px;height:30px" class="img" title="获取验证码" src="" onclick="Yanzheng()">
						</div>
						<div class="admPhoneCode">
							...
							<b style="display:none" class="getYan">验证码已发送!</b>
						</div>
