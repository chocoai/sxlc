...
public class MemberAttestTypeListDaoImpl extends SqlSessionDaoSupport implements MemberAttestTypeListDao {
	...
	public List<MemberAttestTypeEntity> selectMemberAttestTypeAllpage(
		...
		memberAttestTypeList=getSqlSession().selectList("memberAttestType.selectMemberAttestTypeList",pageEntity,
				new RowBounds(pageEntity.getPageNum(),pageEntity.getPageSize()));
		return memberAttestTypeList;
	}
	@Override
	public MemberAttestTypeEntity selectMemberAttestentityByID(int id) {
		
		MemberAttestTypeEntity memberAttestTypeEntity=null;
		memberAttestTypeEntity = getSqlSession().selectOne("memberAttestType.selectMemberAttestentityByID",id);
