...
<body class="nav-md">
				...
				<div class="nav-tabs-con active">
					<div class="data_display">
						...
						<div class="w-content ishow detailAuthen realnameAuthen">
							<fieldset>
								<legend class="titleLen">学历认证</legend>
								<div class="introduce">
								...
								<div class="introduce">
									<span><samp>最高学历：</samp><label id="graduateName"></label></span>
								...
								<div>
									...
									<div id="back"  class="back"  style="display: none">
										<button class="backAuthen" onclick="back('web/member/per-titleAuthen.jsp?content=<%=typeId%>')">返回</button>
									</div>
	...
	<script type="text/javascript" src="js/member/personalIdentySorts/graduateDetail.js"></script>
