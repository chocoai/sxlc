...
<head>
	...
	<!-- 私用css -->
	<link rel="stylesheet" href="css/finance/fn-historyCompensatory.css"/></link>
</head>
...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
			...
			<jsp:include page="../common/cm-finance.jsp">
				<jsp:param value="411" name="_index_m2"/>
	...
	<script type="text/javascript" src="js/finance/fn-historyCompensatory.js"></script>
	<!-- 私用js -->
