	   					...
	   					<div class="authen">
			   				<ul class="inputArea">
			   					<li class="inputList">
			   						...
			   						<input class="inputText" type="text" lang="请输入姓名" maxlength="15"/>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span><samp>*</samp>身份证号：</span></div>
			   						<input class="inputText personId" type="text" lang="请输入身份证号" maxlength="18"/>
			   					</li>
			   					<li class="inputList">
			   						<div class="mustLabel"><span><samp>*</samp>手机号：</span></div>
			   						<input class="inputText phoneBind numberReg" type="text" lang="请输入手机号" maxlength="11"/>
			   					</li>
			   					<li class="inputList">
